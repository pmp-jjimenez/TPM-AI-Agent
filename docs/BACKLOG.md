...
| TBD | AI Expert Council Orchestration | Build on deterministic routing to support AI-assisted council review. | Council review prompt builder; optional multiple model calls; conflict summary; TPM synthesis output; CLI or workspace integration. | Future | Medium |
